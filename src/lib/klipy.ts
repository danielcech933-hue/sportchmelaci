...
export type KlipyItem = { id: string; title: string; sourceUrl: string; preview: KlipyImage; fixedWidth: KlipyImage; original: KlipyImage; mediaType: KlipyMediaType };
...
function nestedImage(file: any, size: string, format: string) { return mapImage(file?.[size]?.[format]); }
