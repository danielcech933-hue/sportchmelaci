-- Fix the daily wheel RPC to use the actual daily_bonus_claims column.
-- The table stores last_claim_at; older deployed function versions referenced claim_at.
