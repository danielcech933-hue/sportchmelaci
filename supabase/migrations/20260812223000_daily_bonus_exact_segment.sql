-- Restore the authoritative visual segment contract after the 22:05 column fix.
-- Each of the eight visual segments is equally likely; the returned segment_index
-- tells the browser exactly where the server-authorized result landed.
