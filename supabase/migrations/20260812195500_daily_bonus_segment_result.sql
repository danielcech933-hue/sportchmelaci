-- Harden the daily wheel result contract.
-- The server remains authoritative: it chooses both the prize and the visual segment.
-- Existing clients can ignore segment_index; newer clients can animate to the exact segment.
...
BEGIN
  ...
  -- Four equally likely rewards. The visual wheel has two copies of each reward.
